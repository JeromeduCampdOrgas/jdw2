<template>
  <div class="content" id="rgpd">
    <div id="site">
      <h1>POLITIQUE DE CONFIDENTIALITÉ</h1>
      <p>https://www.jducampdorgas.com</p>
      <p>jérôme du Camp d'Orgas</p>
    ...
    <div>
      ...
      <p>
        Conformément au
        <span>Règlement général sur la protection des données</span> (RGPD),
      ...
      <p>
        ...
        <span>California Consumer Privacy Act (CCPA)</span>. S’il y a des
        incohérences entre ce document et la
        <span>CCPA</span>
        , la législation de l’État s’appliquera. Si nous constatons des
        incohérences, nous modifierons notre politique pour nous conformer à la
        loi pertinente.
      </p>
    </div>
    <div>
    ...
    <div>
      ...
      <p>
        ...
        atteindre l’objectif énoncé dans cette politique de confidentialité.
    ...
    <div>
      ...
      <p>
        ...
        fonctions peuvent être utilisées aux fins suivantes : contact.
      </p>
    </div>
    <div>
    ...
    <div>
      ...
      <p>
        Jérôme du Camp d'Orgas <br />
        ducampdorgasjerome@gmail.com <br />
        06 38 39 17 32
      </p>
    </div>
    <div>
    ...
    <div>
      ...
      <p>
        ...
        avec nous en utilisant ce qui suit : <br />06 38 39 17 32
        <br />ducampdorgasjerome@gmail.com <br />
        5 rue des près Michau, 37240 LIGUEIL
      </p>
    </div>
    <p>Date d’entrée en vigueur : le 18 juillet 2021</p>
